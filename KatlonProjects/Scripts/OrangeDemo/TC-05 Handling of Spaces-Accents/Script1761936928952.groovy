...
WebUI.setText(findTestObject('Object Repository/OR-OrangeDemo/input_Employee Full Name_firstName'), 'José Rocco')

WebUI.verifyElementAttributeValue(findTestObject('OR-OrangeDemo/input_Employee Full Name_firstName'), 'value', 'José Rocco', 
    3)

WebUI.setText(findTestObject('Object Repository/OR-OrangeDemo/input_Employee Full Name_middleName'), 'Rublingo')

WebUI.verifyElementAttributeValue(findTestObject('OR-OrangeDemo/input_Employee Full Name_middleName'), 'value', 'Rublingo', 
    3)

WebUI.setText(findTestObject('Object Repository/OR-OrangeDemo/input_Employee Full Name_lastName'), 'Mocho')

WebUI.verifyElementAttributeValue(findTestObject('OR-OrangeDemo/input_Employee Full Name_lastName'), 'value', 'Mocho', 3)
...
WebUI.setText(findTestObject('OR-OrangeDemo/input_EmployeeName_Search'), 'José Rocco')

WebUI.verifyElementAttributeValue(findTestObject('OR-OrangeDemo/input_EmployeeName_Search'), 'value', 'José Rocco', 3)
...
WebUI.verifyTextPresent('José Rocco', false)
