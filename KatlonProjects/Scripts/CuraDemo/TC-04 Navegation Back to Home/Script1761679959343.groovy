...
WebUI.selectOptionByValue(findTestObject('OR-CuraDemo/OR-TC02/Make Appointment/select_Facility_combo_facility'), 'Seoul CURA Healthcare Center', 
    false)

WebUI.verifyOptionSelectedByValue(findTestObject('OR-CuraDemo/OR-TC02/Make Appointment/select_Facility_combo_facility'), 
    'Seoul CURA Healthcare Center', false, 3)

WebUI.click(findTestObject('OR-CuraDemo/OR-TC02/Make Appointment/input_Medicare_radio_program_medicare'))

WebUI.verifyElementChecked(findTestObject('OR-CuraDemo/OR-TC02/Make Appointment/input_Medicare_radio_program_medicare'), 
    3)
...
WebUI.setText(findTestObject('Object Repository/OR-CuraDemo/OR-TC02/Make Appointment/textarea_Comment_txt_comment'), 'Navigation from confirmation page to homepage')

WebUI.verifyElementAttributeValue(findTestObject('OR-CuraDemo/OR-TC02/Make Appointment/textarea_Comment_txt_comment'), 'value', 
    'Navigation from confirmation page to homepage', 3)
...
WebUI.verifyMatch(urlAfter, '.*#?summary.*', true)

WebUI.click(findTestObject('OR-CuraDemo/OR-TC02/Summary of Appointment/a_Comment_btn btn-default'))

urlHome = WebUI.getUrl()

WebUI.verifyMatch(urlHome, urlBefore, false)
